    <?php include 'navbar.php';/*show($data['favoris']);*/?>
    
    <section class="d-flex align-items-center px-5">
    <h1 class="mx-5 mt-5" style="color:#3b0000; font-size:72px;"><?php echo $data['user'][0]->nom.' '.$data['user'][0]->prenom ?></h1>
    <div class="mx-5 mt-5">
