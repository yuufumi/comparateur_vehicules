 ...
 <div class="row mx-5">
         ...
         for($i=1;$i<=6;$i++) {
           ...
           "<div class='card mx-5 px-2 my-2 col-md-3' style='border-radius:25px;border: 2px solid #3b0000; background-color:transparent; color:#3b0000'>
               <a href='".ROOT."marques/details/id=1' style=' text-align:center'><img src='".ROOT."/img/marque/fiat.png' class='card-img mt-5' style='margin: auto;' alt='...'></a>
                 <h3 class='card-title py-2' style='text-align:center;'>Marque ".$i." </h3>
             </div>";
         }
         ?>
   </div>
